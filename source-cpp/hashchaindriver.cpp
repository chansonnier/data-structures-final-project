...
int main(){
  ...
  ofstream outfile3;
  ofstream outfile4;
  outfile1.open("insert_performance_hashchain_dataSetA.csv");
  outfile2.open("search_performance_hashchain_dataSetA.csv");
  outfile3.open("insert_collisions_performance_hashchain_dataSetA.csv");
  outfile4.open("search_collisions_performance_hashchain_dataSetA.csv");
  for (int i = 0; i < 100; ++i) {
